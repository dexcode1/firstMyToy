...
public class ExcelMain {
    ...
    public static Map<String, Object> exampleExcelView() {
        ...
        try {
            ...
            //엑셀에 표시될 헤더
            String[] headers = { "과제번호", "분양기관", "연구책임자", "분양 날짜", "비고"};
            //컬럼 별 데이터 길이에 따른 길이 비율. 알파벳 대문자, 알파벳 소문자, 숫자, 기호, 한글에 따라서 길이가 다 다르기 때문에 비율로 크기 조절
            double[] ratido = {4, 5, 4, 4, 7};

            List<String[]> contentList = new ArrayList<>();

            contentList.add(new String[]{"2022-001", "유전체연구과", "김기탁", "2020.1.20", "예시데이터_007"});
            contentList.add(new String[]{"2022-002", "유전체연구과", "김기탁", "2020.1.20", "예시데이터_007"});
            contentList.add(new String[]{"2022-008", "유전체연구과", "김기탁", "2020.1.20", "예시데이터_007"});
            contentList.add(new String[]{"2022-004", "유전체연구과", "김기탁", "2020.1.20", "예시데이터_007"});
            contentList.add(new String[]{"2022-005", "유전체연구과", "김기탁", "2020.1.20", "예시데이터_007"});
            contentList.add(new String[]{"2022-006", "유전체연구과", "김기탁", "2020.1.20", "예시데이터_007"});
            contentList.add(new String[]{"2022-007", "유전체연구과", "김기탁", "2020.1.20", "예시데이터_007"});
            contentList.add(new String[]{"2022-008", "유전체연구과", "김기탁", "2020.1.20", "예시데이터_007"});
