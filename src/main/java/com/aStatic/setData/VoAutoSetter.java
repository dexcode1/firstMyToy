...
public class VoAutoSetter<T> {

    private final Constructor<? extends T> tempConstruct;

    public VoAutoSetter(Class<? extends T> impl) throws NoSuchMethodException {
        this.tempConstruct = impl.getConstructor();
    }

    private void setFieldItem(T tb, String[] keys, String[] content) {
    ...
    public T autoSettingValue(T t, String[] keys, String[] contents) {
    ...
    public T autoTrimAllValue(T t, String[] keys) {
        List<Field> fieldList = new ArrayList<>();
